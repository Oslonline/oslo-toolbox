    ...
    <div className="h-screen max-h-screen w-screen flex items-center justify-center">
      <div className="text-center flex flex-col gap-6">
        ...
        <div className="flex w-full justify-center gap-8">
            ...
            <a className="px-2 py-1 text-lg bg-gray-300 hover:bg-gray-600 hover:text-gray-50 duration-200 rounded-md" href="https://github.com/Oslonline/oslo-toolbox">Github repo</a>
        </div>
      </div>
