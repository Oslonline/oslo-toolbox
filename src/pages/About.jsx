...
function About() {
  return (
    <div className="flex flex-col gap-9 p-6 text-gray-900">
      <div className="flex flex-col gap-2">
        ...
        <div className="mt-6">
          ...
          <p className="mt-2 flex items-center gap-1">
            <span className="font-semibold">The source code </span> can be found on github at :
        ...
        <div className="flex flex-col gap-2 mt-4">
          ...
          <p className="flex items-center gap-1">
            For any inquiries or assistance, please feel free to reach out to me on Twitter at
