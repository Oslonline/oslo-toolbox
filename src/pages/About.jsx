    ...
    return (
        <div className="flex flex-col gap-9 p-6">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="ml-2 text-gray-800"> For any inquiries you can contact me on Twitter <a href="https://twitter.com/Oslo418" className="text-blue-500 underline hover:text-blue-400 focus:text-blue-600">@Oslo418</a></p>
            </div>
            <div id="contact"></div>
        </div>
    );
