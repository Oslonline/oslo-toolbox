...
export default function ReadmeGenerator() {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 md:p-6">
      ...
      <div>
        <p className="text-gray-500 dark:text-gray-400">Generate your GitHub repository README.md for free. Enter your project title, description, installation instructions, usage instructions, and add custom sections as needed. When you're done, you can copy or download your readme !</p>
      </div>
