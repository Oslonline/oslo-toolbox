...
const tools = [
  { name: "CSS generators", link: "/Css", text: "Gradient, Box-shadow...", icon: "/images/tools-ctg/css.webp" },
  { name: "Units converters", link: "/UnitsConvert", text: "Length, Mass, Area...", icon: "/images/tools-ctg/convert.webp" },
